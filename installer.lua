...
local database = {
    ["Same HWID"] = {
        { name = "Same HWID 01", url = "https://github.com/KaelvenSC/APPS-DELTA-LITE/releases/download/delta/NO.MERCY.DELTA.LITE.SAME.HWID.01-2.710.707.apk" },
        { name = "Same HWID 02", url = "https://github.com/KaelvenSC/APPS-DELTA-LITE/releases/download/delta/NO.MERCY.DELTA.LITE.SAME.HWID.02-2.710.707.apk" },
        { name = "Same HWID 03", url = "https://github.com/KaelvenSC/APPS-DELTA-LITE/releases/download/delta/NO.MERCY.DELTA.LITE.SAME.HWID.03-2.710.707.apk" },
        { name = "Same HWID 04", url = "https://github.com/KaelvenSC/APPS-DELTA-LITE/releases/download/delta/NO.MERCY.DELTA.LITE.SAME.HWID.04-2.710.707.apk" },
    },
    ["Not Same HWID"] = {
